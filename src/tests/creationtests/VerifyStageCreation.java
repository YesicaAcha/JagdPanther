...
public class VerifyStageCreation {
	 ...
	 * @throws Exception
	 */	
	@Test (dataProvider = "StageDataXlsx", dataProviderClass = DataProviderClass.class, groups = {"BVT", "Acceptance"})
	public void verifyNewStageIsCreated(String stageName, String stageTitle, String stageDescription, String stageType, String stageGrade) throws Exception{
		...
		StagesPage jagdPantherStagesPage = stagePage
				.setNewStageInformation(stageName, stageTitle, stageDescription, stageType, stageGrade)
				.clickSaveButton();
